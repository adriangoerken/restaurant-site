...
const HeaderActions = ({
	...
	return (
		...
		>
			...
			<button
				type="button"
				className="lg:hidden text-text-primary hover:text-accent transition-colors duration-300 p-2 ml-4 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background-overlay rounded-md"
